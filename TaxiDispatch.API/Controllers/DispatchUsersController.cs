...
public class DispatchUsersController : ControllerBase
{
    private readonly CreateDispatchUserService _service;

    public DispatchUsersController(CreateDispatchUserService service)
    {
        _service = service;
    }
    ...
    [ApiAuthorize]
    [HttpPost("Create")]
    public async Task<IActionResult> Create([FromBody] CreateDispatchUserRequest request)
    {
