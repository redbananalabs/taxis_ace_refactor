...
public class DriverAppControllerThinnessTests
{
    [Fact]
    public void DriverAppController_ShouldNotInjectTaxiDispatchContext()
    {
        var constructor = typeof(DriverAppController).GetConstructors(BindingFlags.Public | BindingFlags.Instance).Single();
    ...
    [Fact]
    public void DriverAppController_ShouldNotContainDirectEfCalls()
    {
    ...
    private static string GetControllerPath()
    {
        ...
        return Path.Combine(root, "TaxiDispatch.API", "Controllers", "DriverAppController.cs");
    }
